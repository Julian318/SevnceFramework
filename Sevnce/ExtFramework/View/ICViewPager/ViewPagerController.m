...
#define kDefaultIndicatorColor [UIColor colorWithRed:178.0/255.0 green:203.0/255.0 blue:57.0/255.0 alpha:0.0]
#define kDefaultTabsViewBackgroundColor [UIColor colorWithRed:234.0/255.0 green:234.0/255.0 blue:234.0/255.0 alpha:0.0]
...
- (void)viewWillLayoutSubviews {
    ...
    frame.size.width = contentSizeWidth>self.view.bounds.size.width?self.view.bounds.size.width:contentSizeWidth;
    frame.size.height = self.tabHeight;
    _tabsView.frame = frame;
    _tabsView.center=CGPointMake(self.view.bounds.size.width*0.5, _tabsView.center.y);
