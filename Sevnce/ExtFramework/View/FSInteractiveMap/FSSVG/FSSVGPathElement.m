...
- (instancetype)initWithAttributes:(NSDictionary *)attributes
{
    ...
    if([attributes objectForKey:@"fillColor"]) {
        self.fillColor = [UIColor colorWithHexString:[attributes objectForKey:@"fillColor"]];
    }
    if([attributes objectForKey:@"strokeColor"]) {
        self.strokeColor = [UIColor colorWithHexString:[attributes objectForKey:@"strokeColor"]];
    }
    if([attributes objectForKey:@"lineWidth"]) {
        self.lineWidth = ((NSString*)[attributes objectForKey:@"lineWidth"]).floatValue;
    }
