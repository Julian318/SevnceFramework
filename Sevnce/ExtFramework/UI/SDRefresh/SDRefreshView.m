...
{
    self.beginRefreshingTarget = target;
    self.beginRefreshingAction = action;
}
-(void)setBeginRefreshingTarget:(id)beginRefreshingTarget{
    _beginRefreshingTarget=beginRefreshingTarget;
}
...
- (void)setRefreshState:(SDRefreshViewState)refreshState
{
    ...
    NSLog(@"%@",self.beginRefreshingTarget);
    switch (refreshState) {
            // 进入刷新状态
...
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
            ...
            else if (self.beginRefreshingOperation) {
