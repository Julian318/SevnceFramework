                            ...
                            checked:(BOOL)isChecked
{
    ...
    NSString *imageName = @"";
    switch (s) {
        case SSCheckBoxViewStyleBox:
            imageName = @"ExtUI.bundle/cb_box_";
            break;
        case SSCheckBoxViewStyleDark:
            imageName = @"ExtUI.bundle/cb_dark_";
            break;
        case SSCheckBoxViewStyleGlossy:
            imageName = @"ExtUI.bundle/cb_glossy_";
            break;
        case SSCheckBoxViewStyleGreen:
            imageName = @"ExtUI.bundle/cb_green_";
            break;
        case SSCheckBoxViewStyleMono:
            imageName = @"ExtUI.bundle/cb_mono_";
            break;
        default:
            return nil;
    }
